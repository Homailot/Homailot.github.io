...
function HomePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col-reverse items-center justify-center gap-4 overflow-hidden bg-satin-linen-50 pt-16 lg:flex-row dark:bg-comet-950">
      <div className="md:bg-gradient-horizontal-edges z-10 h-auto w-full animate-slide-in-bottom md:w-[45rem] md:bg-transparent lg:animate-slide-in-left">
      ...
      <div className="relative sm:mt-8 h-[360px] w-[30rem] lg:h-auto">
        ...
        />
        <PhotoCard
          className="relative animate-slide-in-left mx-auto sm:mx-0 sm:absolute sm:left-[-220px] z-0 sm:z-30 sm:rotate-[7.33deg] sm:animate-[card-drop-3_0.6s_ease-in-out_2.1s_backwards] lg:left-[-66px] lg:top-[-48px]"
